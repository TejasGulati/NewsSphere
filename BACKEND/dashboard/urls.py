...
urlpatterns = [
    ...
    path('articles/category/', ArticlesView.as_view(), name='articles-by-category'),
    ...
    path('notifications/<int:notification_id>/', NotificationsView.as_view(), name='notification-delete'),
]
